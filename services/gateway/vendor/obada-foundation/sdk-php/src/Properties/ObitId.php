...
class ObitId extends Property
{
    ...
    {
        $manufacturer     = new Manufacturer(Arr::get($properties, 'manufacturer', ''));
        $serialNumberHash = new SerialNumberHash(Arr::get($properties, 'serial_number_hash', ''));
        $partNumber       = new PartNumber(Arr::get($properties, 'part_number', ''));
